...
class FillDataArticles extends Migration
{
    ...
    public function up()
    {
        ...
        $obj = App\Article::create(['name'=>'Raspberry Pi 3b+', 'description'=>'Une carte Raspberry Pi 3b+ avec son boitier. Idéal pour monter votre serveur.', 'id_category'=>'7', 'id_images'=>'217', 'id_campus'=>'22', 'stock'=>'50', 'price'=>'10.99']);
