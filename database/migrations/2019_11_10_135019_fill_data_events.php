...
class FillDataEvents extends Migration
{
    ...
    public function up()
    {
        ...
        $obj = App\Event::create(['name'=>'Foot', 'description'=>'Rdv au stade.', 'start_date'=>'2019-12-01', 'end_date'=>null, 'price'=>'0', 'recurrent'=>'1', 'validate'=>'0', 'id_images'=>'252', 'id_users'=>'23']);
        ...
        $obj = App\Event::create(['name'=>'FabLab: création de bornes d\'arcades', 'description'=>'Venez créer des bornes d\'arcades au FabLab.', 'start_date'=>'2019-12-20', 'end_date'=>'2020-01-20', 'price'=>'0', 'recurrent'=>'1', 'validate'=>'1', 'id_images'=>'257', 'id_users'=>'22']);
        $obj = App\Event::create(['name'=>'Atelier couture', 'description'=>'Réparer vos vêtements', 'start_date'=>'2019-12-20', 'end_date'=>null, 'price'=>'1', 'recurrent'=>'1', 'validate'=>'1', 'id_images'=>'258', 'id_users'=>'23']);
