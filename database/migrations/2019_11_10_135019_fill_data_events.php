...
class FillDataEvents extends Migration
{
    ...
    public function up()
    {
        ...
        $obj = App\Event::create(['name'=>'Sortie ski', 'description'=>'', 'start_date'=>'2019-12-02', 'end_date'=>'2019-12-04', 'price'=>'150', 'recurrent'=>'0', 'validate'=>'0', 'id_images'=>'256', 'id_users'=>'106']);
        ...
        $obj = App\Event::create(['name'=>'Atelier couture', 'description'=>'Réparer vos vêtements', 'start_date'=>'2019-12-20', 'end_date'=>null, 'price'=>'1', 'recurrent'=>'1', 'validate'=>'1', 'id_images'=>'258', 'id_users'=>'70']);
        ...
        $obj = App\Event::create(['name'=>'Mario kart Wii', 'description'=>'Compétition de Mario Kart sur Wii', 'start_date'=>'2019-12-22', 'end_date'=>null, 'price'=>'5', 'recurrent'=>'0', 'validate'=>'1', 'id_images'=>'262', 'id_users'=>'22']);
        $obj = App\Event::create(['name'=>'Théatre', 'description'=>'Venez tous les jeudis dans la salle commune pour du théatre d\'improvisation !', 'start_date'=>'2020-01-08', 'end_date'=>null, 'price'=>'0', 'recurrent'=>'1', 'validate'=>'1', 'id_images'=>'263', 'id_users'=>'23']);
        $obj = App\Event::create(['name'=>'Ping-Pong', 'description'=>'Ping - Pong', 'start_date'=>'2020-02-01', 'end_date'=>null, 'price'=>'0', 'recurrent'=>'1', 'validate'=>'0', 'id_images'=>'264', 'id_users'=>'22']);
    }
